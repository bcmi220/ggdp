...
def convert_kcnet_checkpoint_to_pytorch(kcnet_checkpoint_path, pytorch_dump_folder_path):
    # Load checkpoint
...
if __name__ == "__main__":
    ...
    ## Required parameters
    parser.add_argument("--kcnet_checkpoint_path",
                        default = None,
                        type = str,
                        required = True,
    ...
    convert_kcnet_checkpoint_to_pytorch(args.kcnet_checkpoint_path, args.pytorch_dump_folder_path)
